DATA.Fitness = {
    ...
    schedules: {
        ...
        'Weight Lift 10 x 10': [[15, 2, {is_break: true}],
    ...
    programs: {
        ...
        'Session 1/Exercise 1': ['WL-UP', 'WL-DOWN', 'WL-R1', 'WL-R2', 'WL-R3', 'WL-R4', 'WL-R5', 'WL-R6', 'WL-R7', 'WL-R8', 'WL-R9', 'WL-RL'],
    },
    suitable: {
    ...
    sounds: {
        'BW-.*' : {0: 'start', '-1': 'done'},
        'WL-R1' : {'-5': '1st-round'},
        'WL-R2' : {0: 'relax', '-5': '2nd-round'},
        'WL-R3' : {0: 'relax', '-5': '3rd-round'},
        'WL-R4' : {0: 'relax', '-5': '4th-round'},
        'WL-R5' : {0: 'relax', '-5': '5th-round'},
        'WL-R6' : {0: 'relax', '-5': '6th-round'},
        'WL-R7' : {0: 'relax', '-5': '7th-round'},
        'WL-R8' : {0: 'relax', '-5': '8th-round'},
        'WL-R9' : {0: 'relax', '-5': '9th-round'},
        'WL-RL' : {0: 'relax', '-5': 'last-round'},
        'WL-UP' : {0: 'lift'},
        'WL-DOWN' : {0: 'back'},
    }
};
