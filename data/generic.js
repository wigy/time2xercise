DATA.Generic = {
    ...
    schedules: {
        '2 x 20 min + 2 min breaks': [[20*60, 0], [2*60, "Break"], [20*60, 1]],
        '3 x 15 min + 2 min breaks': [[15*60, 0], [2*60, "Break"], [15*60, 1], [2*60, "Break"], [15*60, 2]],
        '4 x 10 min + 2 min breaks': [[10*60, 0], [2*60, "Break"], [10*60, 1], [2*60, "Break"], [10*60, 2], [2*60, "Break"], [10*60, 3]],
    ...
    suitable: {
        '2 x 20 min + 2 min breaks': ['Exercises'],
        '3 x 15 min + 2 min breaks': ['Exercises'],
        '4 x 10 min + 2 min breaks': ['Exercises'],
